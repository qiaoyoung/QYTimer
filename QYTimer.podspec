#
#  Be sure to run `pod spec lint QYTimer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Joeyoung"
  # s.authors            = { "Joeyoung" => "393098486@qq.com" }
  # s.social_media_url   = "http://twitter.com/Joeyoung"
